...
import { ExtHostContext, ExtHostWebviewViewsShape, MainThreadWebviewViewsShape, WebviewExtensionDescription as ExtHostWebviewExtensionDescription, MainThreadWebviewsShape, IWebviewContentOptions } from '../vscode/vs/workbench/api/common/extHost.protocol.js';
...
export class WebViewManager implements MainThreadWebviewViewsShape, MainThreadWebviewsShape {
    ...
    $registerWebviewViewProvider(extension: ExtHostWebviewExtensionDescription, viewType: string, options: { retainContextWhenHidden?: boolean; serializeBuffersForPostMessage: boolean }): void {
